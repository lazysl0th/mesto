...
export const buttonEditAvatar = content.querySelector('.profile__button-edit-avatar');
...
export const popupFormUpdateAvatar = content.querySelector('.popup_form_update-avatar');
export const formUpdateAvatar = popupFormUpdateAvatar.querySelector('.popup__content_type_form');
